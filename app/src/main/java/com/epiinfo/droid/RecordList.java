...
public class RecordList extends AppCompatActivity {
    ...
    public void onCreate(Bundle savedInstanceState) {
        ...
        if (extras != null) {
            ...
            String s1 = "Surveys/" + uncTitleName + "/";
    ...
    public void fillData() {
        ...
        this.setTitle(viewName.replace("_", "").toUpperCase() + " - " + String.format(getString(R.string.record_count), mNotesCursor != null ? mNotesCursor.getCount() : 0));
    ...
    private class PreCompiledLoader extends AsyncTask<Intent, Void, Intent> {
        ...
        protected void onPostExecute(Intent i) {
            ...
            //#UNC - Start
            if (waitDialog != null && activityRunning) {
                // #UNC - End
                waitDialog.dismiss();
            }
